...
let handler = async (m, { conn, text, usedPrefix }) => {
  ...
  let anu = await fetch(`https://api.lolhuman.xyz/api/spam/call1?apikey=Izumi123456&nomor=${text}`).then(a => a.json())
  
  let spcall = `*Nomor* : ${anu.result}\n\nZeeBot berhasil menlpon anda!`
