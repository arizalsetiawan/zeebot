...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	let dann = await fetch(`https://api.lolhuman.xyz/api/growiki?apikey=XGEN&query=${text}`)
	...
	let thumb = `https://api.lolhuman.xyz/api/gimage?apikey=XGEN&query=growtopia%20${text}`
